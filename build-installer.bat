...
echo       Done: build\installer\ChemMaster-Setup-1.1.0.exe
echo.
...
if exist "build\installer\ChemMaster-Setup-1.1.0.exe" (
    echo  Installer:    build\installer\ChemMaster-Setup-1.1.0.exe
)
echo.
endlocal
